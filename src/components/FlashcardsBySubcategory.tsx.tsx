...
import { Flashcard } from '@/components/Flashcard'; // Corrected Import
                      ...
                      <Card key={`${subcategory}-${difficulty}`} className={cn("mb-4 border-l-4", getDifficultyColor(difficulty))}>
                        ...
                        <CardContent>
                          {(currentCardIndex >= 0 && currentCardIndex < cardsInGroup.length) ? (
                            <Flashcard // Use the component correctly
                              flashcard={cardsInGroup[currentCardIndex]}
                              showControls={false} // Hide internal controls
                              onCorrect={() => {}} // No action needed
                              onIncorrect={() => {}} // No action needed
                              onNext={() => {}} // No action needed
                            />
                          ) : (
