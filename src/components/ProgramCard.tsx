...
export const ProgramCard: React.FC<ProgramCardProps> = ({ program }) => {
  ...
  const getDifficultyColor = () => {
    switch (program.difficulty) {
      case 'beginner':
        return 'bg-learny-green text-white';
      case 'intermediate':
        return 'bg-learny-blue text-white';
      case 'advanced':
        return 'bg-learny-purple text-white';
      case 'expert':
        return 'bg-learny-red text-white';
      default:
        return 'bg-learny-blue text-white';
    }
  };
  ...
  return (
    ...
    >
      <Card className="h-full border-gray-200 hover:shadow-md transition-shadow duration-300">
        <CardContent className="pt-6">
          <div className="flex justify-between items-start mb-2">
            ...
            {isCompleted && (
              <span className="flex items-center text-learny-green text-sm font-medium">
          ...
          {program.progress !== undefined && (
            <div className="mb-2">
              <div className="flex justify-between items-center mb-1">
                <span className="text-xs font-medium text-gray-500">Framsteg</span>
                <span className="text-xs font-medium text-gray-500">{program.progress}%</span>
              </div>
        ...
        <CardFooter className="pt-2 pb-4">
          <div className="w-full flex justify-end">
            <span className="text-learny-purple font-medium text-sm flex items-center">
