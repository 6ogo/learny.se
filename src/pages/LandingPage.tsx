      ...
      <section className="py-16 bg-gray-800/50">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <FeatureCard 
              icon={<Brain />}
              title="Interaktiva Flashcards"
              description="Engagerande flashcards med spaced repetition-teknik för optimalt lärande."
            />
            <FeatureCard 
              icon={<BarChart3 />}
              title="Följ Dina Framsteg"
              description="Detaljerad statistik och visualisering av dina studieframsteg."
            />
            <FeatureCard 
              icon={<Clock />}
              title="Anpassade Program"
              description="Skräddarsydda studieprogram baserade på dina mål och inlärningshastighet."
            />
            <FeatureCard 
              icon={<Lightbulb />}
              title="AI-genererade Kort"
              description="Låt vår AI hjälpa dig skapa högkvalitativa flashcards på sekunder."
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <StepCard 
              number={1}
              title="Välj ämne/program"
              description="Välj bland våra färdiga ämnen eller skapa ditt eget personliga program."
            />
            <StepCard 
              number={2}
              title="Studera med flashcards"
              description="Lär dig med interaktiva flashcards som anpassar sig efter din inlärning."
            />
            <StepCard 
              number={3}
              title="Testa dina kunskaper"
              description="Utmana dig själv med kunskapstester för att förstärka inlärningen."
            />
            <StepCard 
              number={4}
              title="Lås upp prestationer"
              description="Håll motivationen uppe genom att samla prestationsbadges och se dina framsteg."
            />
          </div>
        </div>
      </section>
