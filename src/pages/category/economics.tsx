...
export default function EconomicsPage() {
  ...
  const totalFlashcards = getFlashcardsByCategory('economics').length;
  const topics = getTopicsByCategory('economics');
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-4xl font-bold">Ekonomi</h1>
          </div>
          <p className="text-muted-foreground mt-2">
            Grundläggande ekonomiska koncept och finansiell kunskap
          </p>
