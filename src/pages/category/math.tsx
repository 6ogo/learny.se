...
export default function MathPage() {
  ...
  // Get total flashcard count for math category
  const totalFlashcards = getFlashcardsByCategory('math').length;
  
  // Get topics for this category
  const topics = getTopicsByCategory('math');
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mb-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-4xl font-bold">Matematik</h1>
          </div>
          <p className="text-muted-foreground mt-2">
            Från grundläggande aritmetik till avancerad kalkyl
          </p>
